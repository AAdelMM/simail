<nav class="w-[100vw] h-[auto] fixed z-50">
    <div class="container w-[60vw] mx-auto py-10 flex justify-between items-center font-bold px-7 bg-[#efc02e] bg-opacity-80 rounded-b-3xl">
        <!-- Burger Menu Button -->
        ...
        <div class="  w-[100%] hidden   lg:inline-flex justify-around items-center ">
            ...
            <a href="#" class="text-[#1e304e]">Our Vision</a>
            <a href="#" class="text-[#1e304e]">Our Mission</a>
            <a href="#" class="text-[#1e304e]">Our Goal</a>
            <a href="#" class="text-[#1e304e]">About Us</a>
            ...
            <div class="relative">
                ...
                <div class="sub-menu w-[12rem] absolute hidden mt-2 bg-[#efc02e] z-[100] text-[#1e304e]">
                    <a href="#" class="block px-4 py-2">Success Partners</a>
    ...
    <div class="mobile-menu hidden lg:hidden absolute top-30 left-5 w-[50%] bg-[#efc02e] bg-opacity-80 text-[#1e304e] z-50 rounded-3xl">
        ...
        <a href="#" class="block px-4 py-2">Our Vision</a>
        <a href="#" class="block px-4 py-2">Our Mission</a>
        <a href="#" class="block px-4 py-2">Our Goal</a>
        <a href="#" class="block px-4 py-2">About Us</a>
